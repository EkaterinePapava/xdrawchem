...
QMenu *ApplicationWindow::BuildArrowMenu()
{
    ...
    regularArrowAction = arrowSub->addAction( QIcon( QPixmap( arrow_regular_xpm ) ), tr( "Regular Arrow" ) );
    topharpoonArrowAction = arrowSub->addAction( QIcon( QPixmap( arrow_topharpoon_xpm ) ), tr( "Top harpoon" ) );
    bottomharpoonAction = arrowSub->addAction( QIcon( QPixmap( arrow_bottomharpoon_xpm ) ), tr( "Bottom harpoon" ) );
    middleArrowAction = arrowSub->addAction( QIcon( QPixmap( arrow_middle_xpm ) ), tr( "Middle" ) );
    didntworkArrowAction = arrowSub->addAction( QIcon( QPixmap( arrow_didnt_work_xpm ) ), tr( "Did not work" ) );
    dashedArrowAction = arrowSub->addAction( QIcon( QPixmap( arrow_dash_xpm ) ), tr( "Dashed arrow" ) );
    bi1ArrowAction = arrowSub->addAction( QIcon( QPixmap( arrow_bi1_xpm ) ), tr( "BI1 arrow" ) );
    bi2ArrowAction = arrowSub->addAction( QIcon( QPixmap( arrow_bi2_xpm ) ), tr( "BI2 arrow" ) );
    retroArrowAction = arrowSub->addAction( QIcon( QPixmap( arrow_retro_xpm ) ), tr( "Retro arrow" ) );
...
QMenu *ApplicationWindow::BuildCurveArrowMenu()
{
    ...
    carrowCW90Action = arrowSub->addAction( QIcon( QPixmap( cw90_xpm ) ), tr( "90° cw" ) );
    carrowCCW90Action = arrowSub->addAction( QIcon( QPixmap( ccw90_xpm ) ), tr( "90° ccw" ) );
    carrowCW180Action = arrowSub->addAction( QIcon( QPixmap( cw180_xpm ) ), tr( "180° cw" ) );
    carrowCCW180Action = arrowSub->addAction( QIcon( QPixmap( ccw180_xpm ) ), tr( "180° ccw" ) );
    carrowCW270Action = arrowSub->addAction( QIcon( QPixmap( cw270_xpm ) ), tr( "270° cw" ) );
    carrowCCW270Action = arrowSub->addAction( QIcon( QPixmap( ccw270_xpm ) ), tr( "270° ccw" ) );
    carrowBezierAction = arrowSub->addAction( QIcon( QPixmap( cbezier_xpm ) ), tr( "Cubic bezier" ) );
    carrowBezierhalfAction = arrowSub->addAction( QIcon( QPixmap( cbezierhalf_xpm ) ), tr( "Cubic bezier - half arrow" ) );
    carrowBezierfullAction = arrowSub->addAction( QIcon( QPixmap( cbezierfull_xpm ) ), tr( "Cubic bezier - full arrow" ) );
...
QMenu *ApplicationWindow::BuildBracketMenu()
{
    ...
    squareBracketAction = bracketSub->addAction( QIcon( QPixmap( squarebracket_xpm ) ), tr( "Square bracket" ) );
    curveBracketAction = bracketSub->addAction( QIcon( QPixmap( curvebracket_xpm ) ), tr( "Curve bracket" ) );
    braceBracketAction = bracketSub->addAction( QIcon( QPixmap( bracebracket_xpm ) ), tr( "Brace bracket" ) );
    boxBracketAction = bracketSub->addAction( QIcon( QPixmap( boxbracket_xpm ) ), tr( "Box bracket" ) );
    ellipseBracketAction = bracketSub->addAction( QIcon( QPixmap( ellipsebracket_xpm ) ), tr( "Ellipse bracket" ) );
    closedsquareBracketAction = bracketSub->addAction( QIcon( QPixmap( closedsquarebracket_xpm ) ), tr( "Closed square bracket" ) );
    circleBracketAction = bracketSub->addAction( QIcon( QPixmap( circlebracket_xpm ) ), tr( "Circle bracket" ) );
...
void ApplicationWindow::setCurveArrowAction( QAction * action )
{
    if ( action == carrowCW90Action ) {
        ...
        drawCurveArrowButton->setIcon( QIcon( QPixmap( ccw90_xpm ) ) );
    } else if ( action == carrowCW180Action ) {
        m_renderer->setMode_DrawCurveArrow( cw180Arrow );
        drawCurveArrowButton->setDefaultAction( carrowCW180Action );
        drawCurveArrowButton->setIcon( QIcon( QPixmap( cw180_xpm ) ) );
    } else if ( action == carrowCCW180Action ) {
        m_renderer->setMode_DrawCurveArrow( ccw180Arrow );
        drawCurveArrowButton->setDefaultAction( carrowCCW180Action );
        drawCurveArrowButton->setIcon( QIcon( QPixmap( ccw180_xpm ) ) );
    } else if ( action == carrowCW270Action ) {
        m_renderer->setMode_DrawCurveArrow( cw270Arrow );
        drawCurveArrowButton->setDefaultAction( carrowCW270Action );
        drawCurveArrowButton->setIcon( QIcon( QPixmap( cw270_xpm ) ) );
    } else if ( action == carrowCCW270Action ) {
        m_renderer->setMode_DrawCurveArrow( ccw270Arrow );
        drawCurveArrowButton->setDefaultAction( carrowCCW270Action );
        drawCurveArrowButton->setIcon( QIcon( QPixmap( ccw270_xpm ) ) );
    } else if ( action == carrowBezierAction ) {
        m_renderer->setMode_DrawGraphicObject( TYPE_BEZIER, 0 );
        drawCurveArrowButton->setDefaultAction( carrowBezierAction );
        drawCurveArrowButton->setIcon( QIcon( QPixmap( cbezier_xpm ) ) );
    } else if ( action == carrowBezierhalfAction ) {
        m_renderer->setMode_DrawGraphicObject( TYPE_BEZIER, 1 );
        drawCurveArrowButton->setDefaultAction( carrowBezierhalfAction );
        drawCurveArrowButton->setIcon( QIcon( QPixmap( cbezierhalf_xpm ) ) );
    } else if ( action == carrowBezierfullAction ) {
        m_renderer->setMode_DrawGraphicObject( TYPE_BEZIER, 2 );
        drawCurveArrowButton->setDefaultAction( carrowBezierfullAction );
        drawCurveArrowButton->setIcon( QIcon( QPixmap( cbezierfull_xpm ) ) );
    } else {
        qDebug() << "unknown action";
    }
}
